...
export default class EmployeehubBenefitsSection extends React.Component<IEmployeehubBenefitsSectionProps, {}> {
  public render(): React.ReactElement<IEmployeehubBenefitsSectionProps> {
    ...
    return (
      <section className={`${styles.employeehubBenefitsSection} ${hasTeamsContext ? styles.teams : ''}`}>
