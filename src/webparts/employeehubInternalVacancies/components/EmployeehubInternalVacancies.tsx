...
export default class EmployeehubInternalVacancies extends React.Component<IEmployeehubInternalVacanciesProps, {}> {
  public render(): React.ReactElement<IEmployeehubInternalVacanciesProps> {
    ...
    return (
      <section className={`${styles.employeehubInternalVacancies} ${hasTeamsContext ? styles.teams : ''}`}>
