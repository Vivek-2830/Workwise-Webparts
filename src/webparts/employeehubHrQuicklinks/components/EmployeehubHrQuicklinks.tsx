...
export default class EmployeehubHrQuicklinks extends React.Component<IEmployeehubHrQuicklinksProps, {}> {
  public render(): React.ReactElement<IEmployeehubHrQuicklinksProps> {
    ...
    return (
      <section className={`${styles.employeehubHrQuicklinks} ${hasTeamsContext ? styles.teams : ''}`}>
