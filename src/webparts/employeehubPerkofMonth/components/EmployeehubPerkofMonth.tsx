...
export default class EmployeehubPerkofMonth extends React.Component<IEmployeehubPerkofMonthProps, {}> {
  public render(): React.ReactElement<IEmployeehubPerkofMonthProps> {
    ...
    return (
      <section className={`${styles.employeehubPerkofMonth} ${hasTeamsContext ? styles.teams : ''}`}>
