...
export default class HomePageQuickLinksHub extends React.Component<IHomePageQuickLinksHubProps, {}> {
  public render(): React.ReactElement<IHomePageQuickLinksHubProps> {
    ...
    return (
      <section className={`${styles.homePageQuickLinksHub} ${hasTeamsContext ? styles.teams : ''}`}>
