...
export default class EmployeehubHrTeamContact extends React.Component<IEmployeehubHrTeamContactProps, {}> {
  public render(): React.ReactElement<IEmployeehubHrTeamContactProps> {
    ...
    return (
      <section className={`${styles.employeehubHrTeamContact} ${hasTeamsContext ? styles.teams : ''}`}>
