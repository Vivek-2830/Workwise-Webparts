...
export default class EmployeehubOurValues extends React.Component<IEmployeehubOurValuesProps, {}> {
  public render(): React.ReactElement<IEmployeehubOurValuesProps> {
    ...
    return (
      <section className={`${styles.employeehubOurValues} ${hasTeamsContext ? styles.teams : ''}`}>
