...
export default class EmployeehubAnnouncement extends React.Component<IEmployeehubAnnouncementProps, {}> {
  public render(): React.ReactElement<IEmployeehubAnnouncementProps> {
    ...
    return (
      <section className={`${styles.employeehubAnnouncement} ${hasTeamsContext ? styles.teams : ''}`}>
