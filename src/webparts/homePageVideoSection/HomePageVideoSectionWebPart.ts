...
export default class HomePageVideoSectionWebPart extends BaseClientSideWebPart<IHomePageVideoSectionWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IHomePageVideoSectionProps> = React.createElement(
